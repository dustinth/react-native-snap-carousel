...
export default class Carousel extends Component {
  ...
  _repositionScroll(index) {
    ...
    this.repositionToOffset = repositionTo
  }
  ...
  snapToNext(animated = true, fireCallback = true) {
    ...
    if (this.repositionToOffset) {
      stopAutoPlay()
      setTimeout(() => {
        this._snapToItem(this.repositionToOffset, false, false, false, false)
        this._activeItem = this.repositionToOffset
        this.repositionToOffset = null
        setTimeout(() => {
          snapNex()
        }, 500)
      }, 100)
  ...
  _getComponentOverridableProps() {
    const { enableMomentum, itemWidth, itemHeight, loopClonesPerSide, sliderWidth, sliderHeight, vertical } = this.props
